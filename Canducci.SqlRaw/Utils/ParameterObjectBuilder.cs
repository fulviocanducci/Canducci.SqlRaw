...
namespace Canducci.SqlRaw.Utils
{
    internal static class ParameterObjectBuilder
    {
        ...
        public static object CreateObjectWithValues(List<object> values)
        {
            IDictionary<string, object> parameters = new Dictionary<string, object>(values.Count);
            int i = 0;
            values.ForEach(x => parameters.Add($"@p{i++}", x));
            return CreateObjectWithValues(parameters);
        }
        ...
        public static object CreateObjectWithValues(IDictionary<string, object> parameters)
        {
            ...
            foreach (var prop in objType.GetTypeInfo().DeclaredProperties)
#else
        ...
        internal static Type GetTypeParameter(KeyValuePair<string, object> parameter)
        {
            ...
            return value is SqlBuilderParameter queryParameter
